...
public class ConversionStatusResponse {
	...
	public String toString() {
		return "ConversionStatusOutput [id=" + id + ", key=" + key + ", status=" + status + ", sandbox=" + sandbox
				+ ", created_at=" + created_at + ", finished_at=" + finished_at + ", source_file=" + source_file
				+ ", target_files=" + target_files + ", target_format=" + target_format + ", credit_cost=" + credit_cost
				+ "]";
	}
